...
public class GameTenBallsServiceImpl implements IGameTenBallsService {
    ...
    public void addTenBallsBetRecord(Long userId, TenBallsAddBetRecordReqVO vo) {
        ...
        for(int i=0; i<betNumberArg.length; i++){
            ...
            if(newGameTenballRecordList != null && newGameTenballRecordList.size() >0){
                ...
                Map<String, Object> updateAzxy10RecordMap = EntityMapTransUtils.entityToMap1(updateGameTenballRecord);
                ...
                if(vo.getType() == 1){
                    if("单".equals(betNumberArg[i])){
                        ...
                        Object betRecordAmountObject = updateAzxy10RecordMap.get("type1Num" +betNumberArg[i]);
                        ...
                        updateAzxy10RecordMap.put("type1Num" +betNumberArg[i], betMoney);

                        updateGameTenballRecord = EntityMapTransUtils.mapToEntity1(GameTenballRecord.class, updateAzxy10RecordMap);
                    }
                }else{
                    String columnKey = "";
                    if("单".equals(betNumberArg[i])){
                    ...
                    Object betRecordAmountObject = updateAzxy10RecordMap.get(columnKey);
                    Float betRecordAmount = betRecordAmountObject!=null?(Float) betRecordAmountObject:0f;
                    Float betMoney = betRecordAmount + vo.getMoney();
                    updateAzxy10RecordMap.put(columnKey, betMoney);
                ...
                Map<String, Object> newAzxy10RecordMap = EntityMapTransUtils.entityToMap1(newGameTenballRecord);
                ...
                if(vo.getType() == 1){
                    if("单".equals(betNumberArg[i])){
                        ...
                        Object betRecordAmountObject = newAzxy10RecordMap.get("type1Num" +betNumberArg[i]);
                        Float betRecordAmount = betRecordAmountObject!=null?(Float) betRecordAmountObject:0f;
                        Float betMoney = betRecordAmount + vo.getMoney();
                        newAzxy10RecordMap.put("type1Num" +betNumberArg[i], betMoney);

                        newGameTenballRecord = EntityMapTransUtils.mapToEntity1(GameTenballRecord.class, newAzxy10RecordMap);
                    }
                }else{
                    String columnKey = "";
                    if("单".equals(betNumberArg[i])){
                    ...
                    Object betRecordAmountObject = newAzxy10RecordMap.get(columnKey);
                    Float betRecordAmount = betRecordAmountObject!=null?(Float) betRecordAmountObject:0f;
                    Float betMoney = betRecordAmount + vo.getMoney();
                    newAzxy10RecordMap.put(columnKey, betMoney);
    ...
    public void checkBetTenBallLimitAmount(GameTenballRecord gameTenballRecord, String number, Float money, Integer betType){
        ...
        for(int i=0; i<betNumberArg.length; i++){
            Map<String, Object> azxy10RecordMap = EntityMapTransUtils.entityToMap1(gameTenballRecord);
            ...
            if(betType == 1){
                if(tema.contains(betNumberArg[i])){
                    ...
                    Float recordAmount = azxy10RecordMap.get("type1Num"+betNumberArg[i])!=null?(Float) azxy10RecordMap.get("type1Num"+betNumberArg[i]):0f;
                ...
                if(rank.contains(betNumberArg[i])){
                    Object recordAmountObject = azxy10RecordMap.get("type"+(betType - 1) + "Num" +betNumberArg[i]);
                ...
                if(bigSmall.contains(betNumberArg[i])){
                    ...
                    Object singleRecordAmountObject = azxy10RecordMap.get("type"+(betType - 1) + "Single");
                    ...
                    Object doubleRecordAmountObject = azxy10RecordMap.get("type"+(betType - 1) + "Double");
                    ...
                    Object bigRecordAmountObject = azxy10RecordMap.get("type"+(betType - 1) + "Big");
                    ...
                    Object smallRecordAmountObject = azxy10RecordMap.get("type"+(betType - 1) + "Small");
                ...
                if(longTiger.contains(betNumberArg[i])){
                    ...
                    Object loongRecordAmountObject = azxy10RecordMap.get("type"+(betType - 1) + "Loong");
                    ...
                    Object tigerRecordAmountObject = azxy10RecordMap.get("type"+(betType - 1) + "Tiger");
