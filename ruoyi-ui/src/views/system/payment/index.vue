<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="paymentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="收款姓名" align="center" prop="paymentName" />
      ...
      <el-table-column label="收款码图片地址" align="center" prop="paymentPic" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.paymentPic" :width="50" :height="50"/>
        </template>
      </el-table-column>
      <el-table-column label="状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_payment_status" :value="scope.row.status"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="收款姓名" prop="paymentName">
          <el-input v-model="form.paymentName" placeholder="请输入收款姓名" />
        </el-form-item>
        <el-form-item label="收款类型" prop="paymentType">
        ...
        <el-form-item label="收款码图片地址" prop="paymentPic">
          <image-upload v-model="form.paymentPic"/>
        </el-form-item>
        <el-form-item label="状态" prop="status">
