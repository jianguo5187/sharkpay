<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="moneyUpTotalList" show-summary :summary-method="getSummaries">
      ...
      <el-table-column label="总下分金额" align="center" prop="cashMoney" />
    </el-table>
...
<script>
import {listPostal, listUserMoneyDownTotal} from "@/api/system/postal";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listUserMoneyDownTotal(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
